...
\begin{figure}[htbp]
    ...
    \end{minipage}}
    \caption[Row-based training and evaluation protocol]{Protocol overview for the row-based split, training and calibration on Row~1 Late-stage data, held-out evaluation on Row~2, and post-inference reporting stratified by acquisition stage.}
