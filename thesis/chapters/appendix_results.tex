...
\begin{table}[!htbp]
\centering
\caption{Pairwise Jaccard similarity of top-30 wavelengths across seeds (5\,nm bins). Mean Jaccard = 0.562.}
...
\begin{table}[!htbp]
\centering
\caption{Pairwise Jaccard similarity of top-30 wavelengths across seeds (10\,nm bins). Mean Jaccard = 0.697.}
...
\begin{table}[!htbp]
\centering
\caption{Pairwise Jaccard similarity of top-30 wavelengths across seeds (20\,nm bins). Mean Jaccard = 0.811.}
...
\begin{table}[!htbp]
\centering
\caption{Pairwise Jaccard similarity of top-11 wavelengths across seeds (5\,nm bins). Mean Jaccard = 0.536.}
...
\begin{table}[!htbp]
\centering
\caption{Pairwise Jaccard similarity of top-11 wavelengths across seeds (10\,nm bins). Mean Jaccard = 0.639.}
...
\begin{table}[!htbp]
\centering
\caption{Pairwise Jaccard similarity of top-11 wavelengths across seeds (20\,nm bins). Mean Jaccard = 0.640.}
...
\begin{figure}[htbp]
    ...
    \caption{Annotation tool labeling session for a healthy (\textit{Regular}) grape cluster. The operator selects intact berry regions to extract reference spectral signatures.}
...
\begin{figure}[htbp]
    ...
    \caption{Annotation tool labeling session for a cracked grape cluster. The operator targets damaged skin areas to capture the spectral response of cracked tissue.}
...
\begin{figure}[htbp]
    ...
    \caption{True Positive example~1: the pipeline correctly identifies crack regions on the grape cluster.}
...
\begin{figure}[htbp]
    ...
    \caption{True Positive example~2: crack-affected tissue is correctly detected and spatially localized.}
...
\begin{figure}[htbp]
    ...
    \caption{True Positive example~3: another correctly identified cracked cluster showing spatially coherent detection.}
...
\begin{figure}[htbp]
    ...
    \caption{False Positive example~1: a small branch segment triggers a false crack detection due to spectral similarity with cracked tissue.}
...
\begin{figure}[htbp]
    ...
    \caption{False Positive example~2: another small branch misclassified as a crack region.}
...
\begin{figure}[htbp]
    ...
    \caption{False Positive example~3: branch-like structure in the scene produces a spurious crack detection.}
...
\begin{figure}[htbp]
    ...
    \caption{False Positive example~4: multiple small branches visible in the cluster image cause several false crack detections across the field of view.}
