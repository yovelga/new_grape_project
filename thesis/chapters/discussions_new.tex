...
However, when binned to account for spectral collinearity, the cross-seed agreement increases substantially (Table~\ref{tab:binned_jaccard_summary}; Figure~\ref{fig:binned_jaccard_summary}), as discussed in Section~\ref{sec:dimensionality_and_sensors}.
