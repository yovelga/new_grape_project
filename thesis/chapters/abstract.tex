...
\medskip
\noindent
Rigorous feature selection reduced the hyperspectral cube to 30 key wavelengths, highlighting the commercial viability of low-cost sensors. Finally, the spatial pipeline exhibited strong generalization on unseen vineyard rows, proving its robustness to environmental variances and yielding a field-ready solution.
\end{abstract}
