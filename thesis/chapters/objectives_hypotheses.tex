...
\begin{itemize}
    \item \textbf{$H_0$:} There is no statistically significant difference in the spectral signatures of healthy and cracked tissues in ``Scarlotta Seedless'' grapes.
