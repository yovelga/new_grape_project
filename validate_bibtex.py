...
if __name__ == "__main__":
    filepath = r"c:\Users\yovel\Desktop\Grape_Project\thesis\bibliography\references.bib"
    
    validator = BibTexValidator(filepath)
    report = validator.run_analysis()
    
    # Save report
    output_file = r"c:\Users\yovel\Desktop\Grape_Project\bibtex_validation_report.md"
