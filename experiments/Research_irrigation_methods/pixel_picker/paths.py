...
excel_path = str(_PROJECT_ROOT / r"dataset_builder_grapes/Research_irrigation_methods/pixel_picker/first_time_crack.xlsx")
output_txt_path = str(_PROJECT_ROOT / r"dataset_builder_grapes/Research_irrigation_methods/pixel_picker/first_time_crack.txt")
...
for idx, row in df.iterrows():
    ...
    for i in range(1, len(values)):
        if values[i] == 20:
            ...
            date_20 = date_cols[i]
            path_30 = frstr(_PROJECT_ROOT / r'dest/{grape_id}/{date_30}')
            path_20 = frstr(_PROJECT_ROOT / r'dest/{grape_id}/{date_20}')
