...
EXCEL_PATH: str = str(_PROJECT_ROOT / r"src/datasets/taged_grape_clusters/crack_in_image_by_weeks_for_dataset.xlsx")
...
OUTPUT_DIR: str = str(_PROJECT_ROOT / r"src/datasets/full_image/builders/output")
