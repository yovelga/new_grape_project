"""
Build Row 1 Manual Labeling Template from Excel
...
Where:
- grape_id: Extracted from Excel "Grape ID" column (e.g., "1_01")
- row: Row number extracted from grape_id (e.g., 1)
...
2. Filter records for the specified row (default: Row 1)
...
- Grape IDs follow pattern: {row}_{id} (e.g., "1_01" for row 1)
