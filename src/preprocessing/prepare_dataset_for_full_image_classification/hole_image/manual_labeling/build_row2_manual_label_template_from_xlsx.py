...
INPUT_XLSX = str(_PROJECT_ROOT / r"src/preprocessing/prepare_dataset_for_full_image_classification/crack_by_weeks_for_dataset.xlsx")

# Output CSV path
OUTPUT_CSV = str(_PROJECT_ROOT / r"src/preprocessing/prepare_dataset_for_full_image_classification/manual_labeling/output/row2_manual_label_template.csv")
