...
# --- PATHS ---
JSON_DIR_branch = r"C:\Users\yovel\Desktop\Grape_Project\ui\pixel_picker\sam2_results\BRANCH"
...
JSON_DIR_plastic = r"C:\Users\yovel\Desktop\Grape_Project\ui\pixel_picker\sam2_results\PLASTIC"
JSON_DIR_background = r"C:\Users\yovel\Desktop\Grape_Project\ui\pixel_picker\sam2_results\BACKGROUND"
...
def clean_all_classes(df, hdr_path):
    ...
    for class_name in df['label'].unique():
        ...
        if not band_cols:
            logging.warning(f"No band columns found for class {class_name}.")
            continue
