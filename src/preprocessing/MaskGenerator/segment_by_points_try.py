...
SAM2_MODULES = (
    str(_PROJECT_ROOT / r"MaskGenerator/segment-anything-2/sam2")
)
...
JSON_DIR = (
    str(_PROJECT_ROOT / r"dataset_builder_grapes/output/cracks/jsons")
)
MASK_DIR = (
    str(_PROJECT_ROOT / r"dataset_builder_grapes/output/cracks/masks")
)
