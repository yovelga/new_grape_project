...
EXPERIMENT_DIR = Path(rfstr(_PROJECT_ROOT / r"experiments/pixel_level_classifier_compare_multiclass_vs_3class_{TIMESTAMP}"))
# EXPERIMENT_DIR = Path(str(_PROJECT_ROOT / r"experiments/pixel_level_classifier_compare_multiclass_vs_3class"))
