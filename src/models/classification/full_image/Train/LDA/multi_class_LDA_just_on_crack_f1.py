...
MODEL_OUTPUT_PATH = str(_PROJECT_ROOT / r'src/models/classification/full_image/Train/LDA/lda_model_multi_class_f1_score_v2.joblib')
RESULTS_FOLDER = str(_PROJECT_ROOT / r'src/models/classification/full_image/Train/LDA/results')
