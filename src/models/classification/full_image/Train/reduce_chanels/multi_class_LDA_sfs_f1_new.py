...
RESULTS_FOLDER = r'C:\Users\yovel\Desktop\Grape_Project\src\models\classification\full_image\Train\reduce_chanels\results_multi_class_reduce_CRACK_F1'
...
# SELECTION_SAMPLE_SIZE = np.inf # Use full training set (no subsampling)
SELECTION_SAMPLE_SIZE = 400
...
for n_features in tqdm(range(1, 21), desc="Testing feature counts"):
    ...
    print(f'  SFS will perform forward selection with 3-fold CV (CRACK F1-Score)...')
...
textstr += f'Method: Forward Sequential Feature Selection'
...
ax.set_xlabel('Feature Importance (Absolute LDA Coefficient)',
             fontsize=14, fontweight='bold')
ax.set_ylabel('Selected Features / Wavelengths', fontsize=14, fontweight='bold')
ax.set_title(f'Selected Features for Best Model (k={best_n_features})\n' +
            'Feature Importance for CRACK Detection',
...
ax.set_xlabel('Selection Frequency (out of 20 feature counts tested)', fontsize=12, fontweight='bold')
ax.set_ylabel('Wavelength / Feature Name', fontsize=12, fontweight='bold')
