...
# נתיב לקובץ הנתונים (אותו קובץ CSV גדול)
...
# תיקיית התוצאות החדשה
RESULTS_FOLDER = r"C:\Users\yovel\Desktop\Grape_Project\results\xgboost_multi"
...
XGB_PARAMS = {
    ...
    'objective': 'multi:softprob',  # מתאים ל-Multiclass
