...
DEFAULT_DATASET_CSV = str(_PROJECT_ROOT / r"src/preprocessing/prepare_dataset/hole_image/late_detection/late_detection_dataset.csv")
RESULTS_FOLDER = str(_PROJECT_ROOT / r"src/models/classification/full_image/infernce_with_new_model_with_cnn/Results")
...
class HSILateDetectionViewer(QMainWindow):
    ...
    def _build_ui(self):
        ...
        default_cnn_path = str(_PROJECT_ROOT / r"src/models/training_classification_model_cnn_for_grapes_berry/model_weights/best_model_original.pth")
