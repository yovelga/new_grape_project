...
DEFAULT_LATE_DETECTION_CSV = str(_PROJECT_ROOT / r"src/preprocessing/hole_image/late_detection/late_detection_dataset.csv")
...
AVAILABLE_MODELS = {
    ...
    # "NEW LDA Multi-class": str(_PROJECT_ROOT / r"src/models/classification/full_image/classification_by_pixel/Train/LDA/lda_model_multi_class.joblib"),  # Empty - needs retraining
    # "LDA 2-class (CRACK vs other)": str(_PROJECT_ROOT / r"src/models/classification/full_image/classification_by_pixel/Train/LDA/lda_model_2_class.joblib"),  # Empty - needs retraining
}
