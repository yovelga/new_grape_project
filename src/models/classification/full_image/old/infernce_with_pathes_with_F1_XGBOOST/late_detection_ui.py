...
DEFAULT_DATASET_CSV = str(_PROJECT_ROOT / r"src/preprocessing/prepare_dataset_for_full_image_classification/hole_image/late_detection_row_2_test/test_dataset_row2.csv")
