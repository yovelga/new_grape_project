...
MODEL_SAVE_PATH = str(_PROJECT_ROOT / r"training_classification_model_cnn_for_grapes_berry/missclassified/efficientnet_classifier_weights.pth")
MISCLASSIFIED_PATH = str(_PROJECT_ROOT / r"training_classification_model_cnn_for_grapes_berry/missclassified")
