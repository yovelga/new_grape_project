...
# ——— פרמטרים ———
hdr_path = str(_PROJECT_ROOT / r"data/raw/1_14/25.09.24/HS/results/REFLECTANCE_2024-09-25_015.hdr")
gif_output = os.path.join(str(_PROJECT_ROOT / r"src/visualization/4_poster"), "HSI_sequence.gif")
